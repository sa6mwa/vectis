...
separate `auto` and forced-HTTP/1.1 pools, HTTP/2 cancellation in the worker,
connection reuse under cancellation, and BSD kqueue behavior remain
open.
