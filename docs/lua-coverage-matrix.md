...
| workflow:http-client | Downstream HTTP client | yes | yes | yes | yes | planned | JSON helpers, simple non-JSON verbs including HEAD and OPTIONS, form bodies, multipart, file upload/download, retry/proxy/TLS pass-through, reusable client defaults, and structured Vectis/curl errors exist. |
