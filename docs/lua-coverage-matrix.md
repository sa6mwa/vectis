...
| workflow:http-client | Downstream HTTP client | yes | partial | yes | yes | planned | JSON helpers, simple non-JSON verbs, form bodies, multipart, and file upload/download exist; richer client presets remain. |
