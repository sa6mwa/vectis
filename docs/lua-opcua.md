...
server work includes security configuration, access-control callbacks, type and
reference management, methods, browse/path traversal, scalar and array
attributes, events, PubSub/MQTT configuration, and explicit C-only native-pointer
