...
set(CMAKE_NM "${VECTIS_OSXCROSS_BIN_DIR}/${VECTIS_OSXCROSS_HOST}-nm" CACHE FILEPATH "")
...
set(VECTIS_OTOOL "${VECTIS_OSXCROSS_BIN_DIR}/${VECTIS_OSXCROSS_HOST}-otool" CACHE FILEPATH "" FORCE)
set(CMAKE_OTOOL "${VECTIS_OTOOL}" CACHE FILEPATH "Target Mach-O inspection tool" FORCE)
set(CPKT_OTOOL "${VECTIS_OTOOL}" CACHE FILEPATH "pkt.systems target Mach-O inspection tool" FORCE)
set(_cai_otool "${VECTIS_OTOOL}" CACHE FILEPATH "Target Mach-O inspection tool for CAI package ABI validation" FORCE)
