...
assert(type(sus.LOG_NONE) == "number")
assert(type(sus.LOG_DEBUG) == "number")
assert(type(sus.LOG_INFO) == "number")
assert(type(sus.LOG_WARN) == "number")
assert(type(sus.LOG_ERROR) == "number")
assert(type(sus.LOG_CONT) == "number")
assert(sus.set_log_sink(function(event)
  assert(type(event.level) == "number")
  assert(type(event.component) == "string")
