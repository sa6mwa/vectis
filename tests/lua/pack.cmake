...
string(REPLACE
       "assert(vectis.auth.user_add({credentials_path = webdav_credentials, username = \"pack-user\", password = \"pack-password\"}).username == \"pack-user\")"
       "local pack_user = assert(vectis.auth.user_add({credentials_path = webdav_credentials, username = \"pack-user\", password = \"pack-password\", email = \"pack-user@example.test\", totp_secret = \"GEZDGNBVGY3TQOJQGEZDGNBVGY3TQOJQ\", totp_label = \"Vectis:pack-user\", issuer = \"Vectis\"}))\nassert(pack_user.username == \"pack-user\")\nassert(pack_user.email == \"pack-user@example.test\")\nassert(pack_user.totp_secret == \"GEZDGNBVGY3TQOJQGEZDGNBVGY3TQOJQ\")\nlocal pack_email_user = assert(vectis.auth.user_add({credentials_path = webdav_credentials, username = \"pack-email-user\", password = \"pack-email-password\", email = \"pack-email-user@example.test\"}))\nassert(pack_email_user.username == \"pack-email-user\")\nassert(pack_email_user.email == \"pack-email-user@example.test\")\nlocal pack_blocked_user = assert(vectis.auth.user_add({credentials_path = webdav_credentials, username = \"pack-blocked-user\", password = \"pack-blocked-password\", email = \"pack-blocked-user@blocked.test\"}))\nassert(pack_blocked_user.email == \"pack-blocked-user@blocked.test\")"
       asset_script_body "${asset_script_body}")
string(REPLACE
       "assert(pack_user.totp_secret == \"GEZDGNBVGY3TQOJQGEZDGNBVGY3TQOJQ\")"
