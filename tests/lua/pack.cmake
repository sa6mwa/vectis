...
file(WRITE "${asset_manifest_template}" "<!doctype html><title>{{ login_title }}</title><form id=\"embedded-login-template\" method=\"post\" action=\"{{ webdav_key_action }}\" data-realm=\"{{ realm }}\" data-prefix=\"{{ path_prefix }}\"><input name=\"username\"></form>\n")
file(WRITE "${asset_file_login_template}" "<!doctype html><title>{{login_title}}</title><form id=\"file-login-template\" method=\"post\" action=\"{{ webdav_key_action }}\" data-email-token=\"{{ email_token_action }}\" data-realm=\"{{ realm }}\"><input name=\"username\"></form>\n")
