...
execute_process(COMMAND "${VECTIS_BIN}" -a pack --script "${asset_script}" --output "${asset_output}" --asset-dir "/:${asset_dir}" --content-type-map "${content_type_map}" --asset-manifest "${asset_manifest}"
