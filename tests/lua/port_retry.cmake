...
function(vectis_run_command_with_port)
  ...
  foreach(attempt RANGE 1 ${attempts})
    ...
    string(RANDOM LENGTH 8 ALPHABET "0123456789abcdef" selected_run_suffix)
    set(selected_run_id "${selected_port}-${attempt}-${selected_run_suffix}")
    set(command_env "${VECTIS_PORT_RUN_PORT_ENV}=${selected_port}"
                    "VECTIS_PORT_RUN_ID=${selected_run_id}")
