...
workflow_behavior=(
  ...
  "vectis.app|vectis_lua_http|tests/lua/http.cmake|server:upload"
...
packed_behavior=(
  ...
  "WebDAV app|vectis_example_lua_webdav_fileserver_pack|examples/lua/webdav_fileserver.lua|app:webdav"
