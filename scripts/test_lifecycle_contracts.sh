...
assert_lua_example_dx_contract() {
  ...
  if grep -RInE 'rest\.(route|group)[[:space:]]*\(' "$repo_root/examples/lua"; then
    echo "Lua app examples must use direct app receiver route methods" >&2
    exit 1
  fi
...
assert_concurrency_mailbox_contract() {
  assert_contains "$repo_root/manual/lua.md" '\[Lua mailbox\]\(lua-mailbox\.md\)'
  assert_contains "$repo_root/manual/lua-mailbox.md" 'require\("vectis\.mailbox"\)'
  assert_contains "$repo_root/manual/lua-mailbox.md" 'box:pump'
  assert_contains "$repo_root/manual/lua-mailbox.md" 'owner-state callbacks'
  assert_contains "$repo_root/manual/lua-mailbox.md" 'not durable storage'
  assert_contains "$repo_root/manual/lua-mailbox.md" 'private Vectis runtime control bus'
  ...
  assert_contains "$repo_root/manual/lua-app.md" '`request_limit = 0`'
  assert_contains "$repo_root/manual/lua-app.md" 'access_log_path'
  assert_contains "$repo_root/manual/lua-app.md" '`kore_curl_timeout_seconds = 0`'
  assert_contains "$repo_root/manual/lua-app.md" '`kore_quiet = true`'
  ...
  assert_contains "$repo_root/docs/kore-runtime-surface-audit.md" \
    'worker_death_policy'
  assert_not_contains "$repo_root/manual/lua-app.md" \
    'kore-runtime-surface-audit\.md'
  assert_contains "$repo_root/manual/api.md" 'Kore quiet mode'
  assert_contains "$repo_root/manual/lua-app.md" \
  ...
  assert_contains "$repo_root/docs/lua-coverage-matrix.md" 'manual/lua-mailbox\.md'
...
assert_kore_static_runtime_contract() {
  ...
  assert_contains "$repo_root/manual/api.md" \
    'The embedded Kore runtime is a private implementation detail'
...
assert_lockdc_lua_runtime_contract() {
  ...
  assert_contains "$repo_root/manual/lua-lockd.md" 'vectis\.lockd\.native'
  assert_contains "$repo_root/manual/lua-lockd.md" 'client_bundle = "embedded"'
  ...
  assert_contains "$repo_root/manual/lua-lockd.md" 'err\.source = "lockdc"'
  assert_contains "$repo_root/manual/lua-lockd.md" 'err\.source = "vectis"'
  ...
  assert_contains "$repo_root/manual/api.md" 'bounded consumer JSON payload'
...
assert_opcua_lua_runtime_contract() {
  ...
  assert_contains "$repo_root/manual/lua.md" '\[Lua OPC UA\]\(lua-opcua\.md\)'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Array values: `value_boolean_array'
  assert_contains "$repo_root/manual/lua-opcua.md" 'server:read_data_value'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:read_data_value'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:history_read_raw'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:read_boolean_array'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:read_localized_text_array_range'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:add_reference_type'
  assert_contains "$repo_root/manual/lua-opcua.md" 'expanded_node_id_server_uri'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:add_reference_ex'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:read_access_level_ex'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:read_array_dimensions'
  assert_contains "$repo_root/manual/lua-opcua.md" 'browse_children_page'
  assert_contains "$repo_root/manual/lua-opcua.md" 'continuation_point'
  assert_contains "$repo_root/manual/lua-opcua.md" 'server:add_method'
  assert_contains "$repo_root/manual/lua-opcua.md" 'server:add_mqtt_pubsub_connection'
  assert_contains "$repo_root/manual/lua-opcua.md" 'server:write_pubsub_configuration'
  assert_contains "$repo_root/manual/lua-opcua.md" 'server:set_access_control'
  assert_contains "$repo_root/manual/lua-opcua.md" 'server:set_default_security'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:set_default_encryption'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:endpoint_count'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:find_servers'
  assert_contains "$repo_root/manual/lua-opcua.md" 'methods use 1-based Lua indexes'
  assert_contains "$repo_root/manual/lua-opcua.md" 'The facade does not read files implicitly'
  assert_contains "$repo_root/manual/lua-opcua.md" 'The callback is retained by the server'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Server PubSub helpers mirror cpkt'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:call_method_many'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:monitor_value_ex'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Value-monitor callbacks receive owned Lua tables'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:monitor_event_fields'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Event-monitor callbacks follow the same retention and error rules'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:call_method_async'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:browse_children_async'
  assert_contains "$repo_root/manual/lua-opcua.md" 'client:add_variable_async'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Async client callbacks are retained by the client until completion'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Method callbacks registered'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Every Lua-created OPC UA client or server is owned by the `lua_State`'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Background threads must not call Lua callbacks directly'
  assert_contains "$repo_root/manual/lua-opcua.md" 'Kore serving and lockd consumption can run simultaneously'
  assert_contains "$repo_root/manual/lua-opcua.md" 'all non-native client/server symbols'
  assert_contains "$repo_root/manual/lua-opcua.md" 'no client-side PubSub symbols'
  assert_contains "$repo_root/manual/lua-opcua.md" 'VECTIS_OPCUA_PUBSUB_LIVE=1 make'
  assert_contains "$repo_root/manual/lua-opcua.md" 'C-Only Native-Pointer Surfaces'
  assert_contains "$repo_root/manual/lua-opcua.md" 'cpkt_opcua_client_native_config'
  assert_contains "$repo_root/manual/lua-opcua.md" 'cpkt_opcua_server_native_config'
  assert_contains "$repo_root/manual/lua-opcua.md" 'cpkt_opcua_client_read_native_variant'
  assert_contains "$repo_root/manual/lua-opcua.md" 'cpkt_opcua_server_read_native_data_value'
  assert_contains "$repo_root/manual/lua-opcua.md" 'borrowed native open62541 pointers'
  assert_contains "$repo_root/manual/lua-opcua.md" 'must not be exposed as Lua userdata'
  assert_contains "$repo_root/manual/lua-opcua.md" 'pointer values'
...
assert_lua_coverage_matrix_contract() {
  ...
  assert_contains "$matrix" '\[`manual/lua\.md`\]\(\.\./manual/lua\.md\)'
  ...
  assert_contains "$repo_root/manual/lua-app.md" 'app:route'
  assert_contains "$repo_root/manual/lua-app.md" 'app:dsv'
  ...
  assert_contains "$repo_root/manual/lua-xml.md" 'vectis_xml_write_lonejson'
  ...
  assert_contains "$matrix" '`app:openapi_doc\(\)` attaches route metadata'
  ...
  assert_contains "$matrix" 'New Lua module documentation must be linked from `manual/lua\.md`'
  ...
  assert_contains "$repo_root/TODO.md" '\[x\] Add Lua request-body streaming policies through a dedicated `app:upload\(\)` helper'
  assert_contains "$repo_root/TODO.md" '\[x\] Add packed API example coverage for live Lua `stream_source`, `app:sse`, and true request-body streaming upload routes'
  assert_contains "$repo_root/TODO.md" 'live `stream_source`/`app:sse` responses'
  ...
  assert_contains "$matrix" '`app:upload` provides true request-body streaming'
  assert_contains "$matrix" '`app:sse` provides live SSE framing'
  assert_contains "$matrix" 'packable Lua API example exercises stream, SSE, and upload routes'
  assert_contains "$repo_root/src/vectis_cli.c" 'vectis_lua_app_upload_dispatch'
  assert_contains "$repo_root/src/vectis_cli.c" 'vectis_lua_app_upload'
  ...
  assert_contains "$repo_root/src/vectis_cli.c" 'vectis_lua_app_sse'
  ...
  assert_contains "$repo_root/manual/lua-app.md" '`spooled_source` is a file-backed response source'
  assert_contains "$repo_root/manual/lua-app.md" '`stream_source` is a live response source'
  assert_contains "$repo_root/manual/lua-app.md" '`app:upload\(opts\)` registers a route'
  assert_contains "$repo_root/manual/lua-app.md" '`app:sse\(opts\)` registers a GET route'
  ...
  assert_contains "$repo_root/src/vectis_cli.c" 'vectis_lua_app_openapi_doc'
  assert_contains "$repo_root/src/vectis_cli.c" 'vectis_lua_app_openapi_schema_refs_free_all'
  assert_contains "$repo_root/src/vectis_cli.c" 'openapi_schema_refs'
  assert_contains "$repo_root/manual/lua-app.md" 'app:openapi_doc'
  assert_contains "$repo_root/manual/lua-app.md" 'app:openapi'
  ...
  assert_contains "$repo_root/examples/lua/api_server.lua" 'app:openapi'
  assert_contains "$repo_root/examples/lua/api_server.lua" 'stream_source'
  assert_contains "$repo_root/examples/lua/api_server.lua" 'app:sse'
  assert_contains "$repo_root/examples/lua/api_server.lua" 'app:upload'
  ...
  assert_contains "$repo_root/manual/lua-lockd.md" 'with_acquired_lease'
  assert_contains "$repo_root/manual/lua-lockd.md" 'with_dequeued_json'
  assert_contains "$repo_root/manual/lua-lockd.md" 'enqueue_json'
  assert_contains "$repo_root/manual/lua-lockd.md" 'load_json'
  assert_contains "$repo_root/manual/lua-lockd.md" 'save_json'
  assert_contains "$repo_root/lua/vectis/lockd.lua" 'native = lockdc'
  assert_contains "$repo_root/manual/lua-lockd.md" 'Use direct `require\("lockdc"\)` or `vectis\.lockd\.native`'
  assert_contains "$repo_root/manual/lua-lockd.md" 'complete lockd API'
  assert_contains "$repo_root/manual/lua-lockd.md" 'queue ack/nack/extend'
  ...
  assert_contains "$repo_root/manual/lua-certs.md" 'require\("openssl"\)'
  ...
  assert_contains "$repo_root/manual/lua-openssl.md" 'current lower-level surface is limited'
  assert_contains "$repo_root/manual/lua-openssl.md" 'Do not add Lua bindings for OpenSSL object lifetime management'
  ...
  assert_contains "$repo_root/manual/lua-ssh.md" 'sftp_stat'
  assert_contains "$repo_root/manual/lua-ssh.md" 'sftp_chmod'
  assert_contains "$repo_root/manual/lua-ssh.md" 'sftp_open'
  assert_contains "$repo_root/manual/lua-ssh.md" 'vectis\.ssh\.open'
  assert_contains "$repo_root/manual/lua-ssh.md" 'session:exec'
  assert_contains "$repo_root/manual/lua-ssh.md" 'session:sftp_open'
  assert_contains "$repo_root/manual/lua-ssh.md" 'session:open_file'
  assert_contains "$repo_root/manual/lua-ssh.md" 'SFTP_OPEN_READ'
  assert_contains "$repo_root/manual/lua-ssh.md" 'dir:read'
  assert_contains "$repo_root/manual/lua-ssh.md" 'host_key_sha256'
  assert_contains "$repo_root/manual/lua-ssh.md" 'SHA256:<base64>'
  ...
  assert_contains "$repo_root/manual/lua-conventions.md" 'err\.source'
  assert_contains "$repo_root/manual/lua-conventions.md" 'err\.dependency_code'
  ...
  assert_contains "$repo_root/manual/lua-status.md" 'canonical `source` text derived from'
  ...
  assert_contains "$repo_root/manual/lua-rest.md" 'minimal `500` JSON response'
  ...
  assert_contains "$repo_root/manual/lua-rest.md" 'If request JSON cannot be encoded'
  ...
  assert_not_contains "$lua_index" 'lua-coverage-matrix\.md'
  assert_not_contains "$lua_index" 'lua-sus-audio-contract\.md'
  ...
  assert_contains "$repo_root/manual/lua-conventions.md" 'Expected runtime failures return structured values'
  assert_contains "$repo_root/manual/lua-conventions.md" 'Programmer misuse raises a Lua error'
  assert_contains "$repo_root/manual/lua-conventions.md" '## Naming And Options'
  assert_contains "$repo_root/manual/lua-conventions.md" 'Timeout and duration fields use unit-suffixed names'
  assert_contains "$repo_root/manual/lua-conventions.md" 'Callback-owned request/event tables contain copied scalar values'
  assert_contains "$repo_root/manual/lua-conventions.md" 'Do not describe a materialized or spooled path as streaming'
  ...
  assert_contains "$repo_root/manual/api.md" '\[Lua CAI\]\(lua-cai\.md\)'
  assert_contains "$repo_root/manual/lua-cai.md" 'dependency-native CAI Lua module'
  assert_contains "$repo_root/manual/lua-cai.md" 'The pinned CAI dependency is `0\.6\.0`'
  assert_contains "$repo_root/manual/lua-cai.md" '`vectis\.cai` is a service DX'
  assert_contains "$repo_root/manual/lua-cai.md" 'not a second AI SDK'
  assert_contains "$repo_root/manual/lua-cai.md" 'The C adapters preserve true streaming'
  ...
  assert_contains "$repo_root/manual/api.md" '\[Lua libmdf\]\(lua-libmdf\.md\)'
  assert_contains "$repo_root/manual/api.md" '\[Lua softline\]\(lua-softline\.md\)'
  assert_contains "$repo_root/manual/lua-libmdf.md" 'dependency-native libmdf Lua module'
  assert_contains "$repo_root/manual/lua-libmdf.md" 'libmdf\.render_stream'
  assert_contains "$repo_root/manual/lua-softline.md" 'dependency-native softline Lua module'
  assert_contains "$repo_root/manual/lua-softline.md" 'softline\.new'
  assert_contains "$matrix" 'documented in `manual/lua-libmdf\.md`'
  assert_contains "$matrix" 'documented in `manual/lua-softline\.md`'
  ...
  assert_contains "$lua_index" '`vectis\.app`'
  ...
  assert_contains "$repo_root/src/vectis_cli.c" 'runtime, "vectis\.app"'
  ...
  assert_contains "$repo_root/src/vectis_cli.c" 'vectis_lua_set_required_module\(lua, "app", "vectis\.app"\)'
  ...
  assert_contains "$repo_root/manual/lua-embedded.md" 'require\("vectis\.embedded"\)'
  assert_contains "$repo_root/manual/lua-embedded.md" 'structured Vectis errors'
  ...
  assert_contains "$repo_root/manual/lua-http.md" '`delete`,'
  assert_contains "$repo_root/manual/lua-http.md" '`head`, and `options` set the HTTP method'
  assert_contains "$repo_root/manual/lua-http.md" '`options_json` set the HTTP method'
  assert_contains "$repo_root/manual/lua-http.md" 'download_file\(url, path'
  ...
  assert_contains "$repo_root/manual/lua-rest.md" '`get`, `post`, `put`, `patch`, `delete`, `head`, and `options`'
  ...
  assert_contains "$lua_index" '\[Lua app\]\(lua-app\.md\)'
  ...
  assert_contains "$matrix" 'manual/lua-audio\.md'
  assert_contains "$matrix" 'manual/lua-sus\.md'
  assert_contains "$repo_root/manual/lua-audio.md" 'audio\.decoder\.open_reader'
  assert_contains "$repo_root/manual/lua-audio.md" 'audio\.capture\.open_default'
  assert_contains "$repo_root/manual/lua-audio.md" 'audio\.playback\.open_default'
  assert_contains "$repo_root/manual/lua-sus.md" 'sus\.open_cached'
  assert_contains "$repo_root/manual/lua-sus.md" 'model:reset_transcript_spacing'
  assert_contains "$repo_root/docs/lua-sus-audio-contract.md" 'manual/lua-audio\.md'
  assert_contains "$repo_root/docs/lua-sus-audio-contract.md" 'manual/lua-sus\.md'
  ...
  assert_contains "$repo_root/manual/lua-webdav.md" 'root_dir` to serve a direct'
  ...
  assert_contains "$repo_root/manual/lua-terminal.md" 'terminal\.markdown_stream'
  assert_contains "$repo_root/manual/lua-terminal.md" 'vectis\.terminal\.libs\.libmdf'
  ...
  assert_contains "$repo_root/manual/lua-log.md" 'log\.log_error'
  assert_contains "$repo_root/manual/lua-log.md" 'log\.from_env'
  assert_contains "$repo_root/manual/lua-log.md" 'vectis\.log\.native'
  ...
  assert_contains "$repo_root/manual/lua-pslog.md" 'pslog\.new_json'
  assert_contains "$repo_root/manual/lua-pslog.md" 'pslog\.from_env'
  assert_contains "$repo_root/manual/lua-lql.md" 'client:selector_parse'
  assert_contains "$repo_root/manual/lua-lql.md" 'client:apply_string_spooled'
  assert_contains "$repo_root/manual/lua-lql.md" 'Do not add a Vectis-owned helper'
  ...
  assert_contains "$repo_root/manual/lua-app.md" 'Managed app-owned services inherit the app logger'
  ...
  assert_contains "$repo_root/scripts/test_lua_rock.sh" 'vectis\.auth\.workflow'
  ...
  assert_contains "$repo_root/manual/lua-rest.md" 'REST does not provide lockd-specific route presets'
  assert_contains "$repo_root/examples/lua/lockd_state.lua" 'vectis\.lockd\.save_json'
  assert_contains "$repo_root/examples/lua/lockd_queue.lua" 'vectis\.lockd\.with_dequeued_json'
  ...
  assert_contains "$repo_root/examples/lua/api_server.lua" 'app:json'
  ...
  assert_contains "$repo_root/examples/lua/downstream_api.lua" 'app:json'
  assert_contains "$repo_root/examples/lua/downstream_api.lua" 'rest\.client'
  assert_contains "$repo_root/manual/lua-auth.md" 'basic_authorization'
  assert_contains "$repo_root/manual/lua-auth.md" 'workflow'
  assert_contains "$matrix" 'Basic Authorization formatting'
  assert_contains "$matrix" 'vectis\.auth\.workflow'
  ...
  assert_contains "$repo_root/scripts/stage_lua_rock_sources.sh" 'manual/\*\.md'
  ...
  assert_contains "$repo_root/manual/lua-zlib.md" 'file-backed'
  assert_contains "$repo_root/manual/lua-zlib.md" 'Do not add a Vectis-owned'
  assert_contains "$repo_root/manual/api.md" '\[Lua zlib\]\(lua-zlib\.md\)'
...
assert_contains "$repo_root/manual/api.md" 'include/vectis/vectis\.h'
assert_contains "$repo_root/manual/api.md" '\[Lua surface\]\(lua\.md\)'
assert_not_contains "$repo_root/manual/api.md" 'lua-coverage-matrix\.md'
assert_contains "$repo_root/manual/api.md" 'vectis_status_string\(\)'
assert_contains "$repo_root/manual/api.md" 'vectis_register_route\(\)'
assert_contains "$repo_root/manual/api.md" 'vectis_response_\*'
assert_contains "$repo_root/manual/api.md" 'vectis_webdav_mount_config'
assert_contains "$repo_root/manual/api.md" 'vectis_auth_routes_config'
assert_contains "$repo_root/manual/api.md" 'vectis_auth_basic_authorization\(\)'
assert_contains "$repo_root/manual/api.md" 'vectis_openapi_document'
assert_contains "$repo_root/manual/api.md" 'vectis_lockd_config'
assert_contains "$repo_root/manual/api.md" 'vectis_http_client_config'
assert_contains "$repo_root/manual/api.md" 'vectis_ssh_config'
assert_contains "$repo_root/manual/api.md" 'vectis_mqtt_config'
assert_contains "$repo_root/manual/api.md" 'Certificates'
...
assert_contains "$repo_root/manual/lua-certs.md" 'vectis_cert_inspect_bundle'
assert_contains "$repo_root/TODO.md" '\[x\] Add source-backed C SDK certificate bundle inspection'
assert_contains "$repo_root/manual/api.md" '\[Lua auth\]\(lua-auth\.md\)'
assert_contains "$repo_root/manual/api.md" '\[Lua SSH\]\(lua-ssh\.md\)'
