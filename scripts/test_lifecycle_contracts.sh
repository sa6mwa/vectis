...
assert_lua_coverage_matrix_contract() {
  ...
  assert_contains "$matrix" 'server lifecycle/value foundation with normal and packed local e2e'
  ...
  assert_contains "$matrix" 'Server lifecycle/value foundation is covered by direct and packed local e2e'
