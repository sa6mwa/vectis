...
assert_concurrency_mailbox_contract() {
  ...
  assert_contains "$repo_root/docs/lua-app.md" '`request_limit = 0`'
  assert_contains "$repo_root/docs/lua-app.md" 'access_log_path'
  assert_contains "$repo_root/docs/lua-app.md" '`kore_curl_timeout_seconds = 0`'
  assert_contains "$repo_root/docs/lua-app.md" '`kore_quiet = true`'
  ...
  assert_contains "$repo_root/docs/kore-runtime-surface-audit.md" \
    'worker_death_policy'
  assert_contains "$repo_root/docs/lua-app.md" \
...
assert_lua_coverage_matrix_contract() {
  ...
  assert_contains "$repo_root/docs/lua-app.md" 'app:route'
  assert_contains "$repo_root/docs/lua-app.md" 'app:dsv'
  ...
  assert_contains "$repo_root/docs/lua-app.md" '`spooled_source` is a file-backed response source'
  assert_contains "$repo_root/docs/lua-app.md" '`stream_source` is a live response source'
  assert_contains "$repo_root/docs/lua-app.md" '`app:upload\(opts\)` registers a route'
  assert_contains "$repo_root/docs/lua-app.md" '`app:sse\(opts\)` registers a GET route'
  ...
  assert_contains "$repo_root/docs/lua-app.md" 'app:openapi_doc'
  assert_contains "$repo_root/docs/lua-app.md" 'app:openapi'
  ...
  assert_contains "$repo_root/docs/lua-app.md" 'Managed app-owned services inherit the app logger'
  ...
  assert_contains "$repo_root/docs/lua-auth.md" 'workflow'
