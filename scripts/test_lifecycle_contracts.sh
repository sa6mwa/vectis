...
assert_lua_coverage_matrix_contract() {
  ...
  assert_contains "$repo_root/docs/lua-lockd.md" 'Use direct `require\("lockdc"\)` or `vectis\.lockd\.raw`'
  ...
  assert_contains "$repo_root/tests/lua/lockd_helpers.cmake" 'raw_client:acquire'
