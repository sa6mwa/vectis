...
- [ ] Complete OPC UA Lua client async, subscription, native-pointer exclusion, array-dimension, and PubSub-related workflows with explicit Lua callback lifetime/error semantics and deterministic local e2e.
