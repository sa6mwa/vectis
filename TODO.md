...
- [ ] Add Lua SSE route helpers and any remaining request-body streaming policies; keep buffered routes, live `stream_source` responses, and file-backed `spooled_source` behavior explicitly separate.
