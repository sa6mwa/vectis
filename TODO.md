...
- [x] Add deterministic e2e coverage for a packed Lua webserver with generated embedded assets, native auth routes, WebDAV key issuance, authenticated embedded WebDAV reads, and mutable WebDAV writes.
