...
- [ ] Complete OPC UA Lua client async, subscription, expanded-node/native-pointer, array-dimension, and PubSub-related workflows with explicit Lua callback lifetime/error semantics and deterministic local e2e.
...
- [ ] Run the lifecycle release-review gate with the same review command mandated
  by the lifecycle skill,
