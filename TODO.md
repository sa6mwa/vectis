...
- [ ] Complete OPC UA Lua client async, subscription, method-call, remote node-management, and PubSub-related workflows with explicit Lua callback lifetime/error semantics and deterministic local e2e.
